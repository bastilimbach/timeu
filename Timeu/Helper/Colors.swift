...
//  Timeu
//
//  Created by Sebastian Limbach on 20.01.2018.
...
extension UIColor {
    ...
    /// Timeu highlight text color
    class var timeuHighlightText: UIColor {
        return UIColor.init(r: 37, g: 220, b: 189, a: 1)
    }

    /// Timeu subheader text color
    class var timeuSubheaderColor: UIColor {
